...
export function ResumeList({ setShowModal }: IContentProp) {
  ...
  return (
    <section className={styles.section}>
      ...
      <ul>
        {resume.map((item) => (
          <ResumeItem key={item.id} deleteResume={deleteResume} {...item} />
        ))}
      </ul>
    </section>
  );
